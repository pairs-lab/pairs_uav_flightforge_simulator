...
#include <pairs_uav_flightforge_simulator/srv/set_orientation.hpp>
...
namespace pairs_uav_flightforge_simulator
{
...
private:
  ...
  /* std::shared_ptr<pairs_lib::ThreadTimer> timer_main_ */
  void timerMain();
  ...
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::Range>>       ph_rangefinders_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>> ph_lidars_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>> ph_seg_lidars_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>> ph_int_lidars_;
  ...
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>> ph_rgb_camera_info_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>> ph_rgb_seg_camera_info_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>> ph_stereo_left_camera_info_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>> ph_stereo_right_camera_info_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>> ph_depth_camera_info_;

  // | ------------------------- system ------------------------- |

  std::vector<std::unique_ptr<pairs_multirotor_simulator::UavSystemRos>> uavs_;
  ...
  std::shared_ptr<pairs_lib::TransformBroadcaster>       dynamic_broadcaster_;
...
FlightforgeSimulator::FlightforgeSimulator(rclcpp::NodeOptions options) : Node("pairs_uav_flightforge_simulator", options) {
...
void FlightforgeSimulator::timerInit() {
  ...
  std::string yaml_prefix = "pairs_uav_flightforge_simulator/";
  ...
  dynparam_mgr_->register_param(yaml_prefix + "realtime_factor", &drs_params_.realtime_factor, pairs_lib::DynparamMgr::range_t<double>(0.01, 10), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackRealtimeFactor, this, std::placeholders::_1));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "collisions/rebounce", &drs_params_.collisions_rebounce, pairs_lib::DynparamMgr::range_t<double>(0.1, 1000));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "sensors/rangefinder/rate", &drs_params_.rangefinder_rate, pairs_lib::DynparamMgr::range_t<double>(1.0, 100.0), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackRangefinderRate, this, std::placeholders::_1));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "sensors/lidar/rate", &drs_params_.lidar_rate, pairs_lib::DynparamMgr::range_t<double>(1.0, 20.0), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackLidarRate, this, std::placeholders::_1));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "sensors/lidar/lidar_segmented/rate", &drs_params_.lidar_seg_rate, pairs_lib::DynparamMgr::range_t<double>(1.0, 20.0), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackLidarSegRate, this, std::placeholders::_1));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "sensors/lidar/lidar_intensity/rate", &drs_params_.lidar_int_rate, pairs_lib::DynparamMgr::range_t<double>(1.0, 20.0), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackLidarIntRate, this, std::placeholders::_1));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "sensors/rgb/rate", &drs_params_.rgb_rate, pairs_lib::DynparamMgr::range_t<double>(1.0, 100.0), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackRgbRate, this, std::placeholders::_1));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "sensors/rgb/rgb_segmented/rate", &drs_params_.rgb_segmented_rate, pairs_lib::DynparamMgr::range_t<double>(1.0, 100.0), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackRgbSegRate, this, std::placeholders::_1));
  ...
  dynparam_mgr_->register_param(yaml_prefix + "sensors/stereo/rate", &drs_params_.stereo_rate, pairs_lib::DynparamMgr::range_t<double>(1.0, 30.0), (std::function<void(const double&)>)std::bind(&FlightforgeSimulator::callbackStereoRate, this, std::placeholders::_1));
  ...
  dynamic_broadcaster_ = std::make_shared<pairs_lib::TransformBroadcaster>(node_);
  ...
  for (size_t i = 0; i < uav_names.size(); i++) {
    ...
    pairs_multirotor_simulator::UavSystemRos_CommonHandlers_t common_handlers;

    common_handlers.node                  = node_;
    common_handlers.uav_name              = uav_name;
    common_handlers.transform_broadcaster = tf_broadcaster_;

    uavs_.push_back(std::make_unique<pairs_multirotor_simulator::UavSystemRos>(common_handlers));
  }
  ...
  if (!res || api_version_major != API_VERSION_MAJOR || api_version_minor != API_VERSION_MINOR) {
    ...
    RCLCPP_ERROR(node_->get_logger(), "           1. make sure the pairs_uav_unreal_simulation package is up to date");
  ...
  for (size_t i = 0; i < uav_names.size(); i++) {
    ...
    pairs_multirotor_simulator::MultirotorModel::State uav_state = uavs_[i]->getState();
    ...
    ph_rangefinders_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::Range>(node_, "/" + uav_name + "/rangefinder"));
    ph_lidars_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>(node_, "/" + uav_name + "/lidar/points"));
    ph_seg_lidars_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>(node_, "/" + uav_name + "/lidar_segmented/points"));
    ph_int_lidars_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::PointCloud2>(node_, "/" + uav_name + "/lidar_intensity/points"));
    ...
    ph_rgb_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>(node_, "/" + uav_name + "/rgb/camera_info"));
    ph_rgb_seg_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>(node_, "/" + uav_name + "/rgb_segmented/camera_info"));
    ph_stereo_left_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>(node_, "/" + uav_name + "/stereo/left/camera_info"));
    ph_stereo_right_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::msg::CameraInfo>(node_, "/" + uav_name + "/stereo/right/camera_info"));
  ...
  pairs_lib::TimerHandlerOptions timer_opts_sensors;
...
void FlightforgeSimulator::timerStatus() {
  ...
  auto actual_rtf = pairs_lib::get_mutexed(mutex_actual_rtf_, actual_rtf_);
  ...
  pairs_lib::set_mutexed(mutex_actual_rtf_, actual_rtf, actual_rtf_);
}
...
void FlightforgeSimulator::timerTimeSync() {
  ...
  auto wall_time_offset = pairs_lib::get_mutexed(mutex_wall_time_offset_, wall_time_offset_);
...
void FlightforgeSimulator::timerRangefinder() {
  ...
  for (size_t i = 0; i < uavs_.size(); i++) {
    ...
    auto                    last_step_time = pairs_lib::get_mutexed(mutex_sim_time_, last_step_time_);
...
void FlightforgeSimulator::timerLidar() {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("timerLidar()"); */

  auto drs_params = pairs_lib::get_mutexed(mutex_drs_params_, drs_params_);

  for (size_t i = 0; i < uavs_.size(); i++) {

    // pairs_multirotor_simulator::MultirotorModel::State state = uavs_[i]->getState();
...
void FlightforgeSimulator::timerSegLidar() {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("timerSegLidar()"); */
...
void FlightforgeSimulator::timerIntLidar() {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("timerIntLidar()"); */
...
void FlightforgeSimulator::timerRgb() {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer(node_, "timerRgb()"); */
...
void FlightforgeSimulator::timerStereo() {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("timerStereo()"); */
...
void FlightforgeSimulator::timerRgbSegmented() {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("timerRgbSegmented()"); */
...
void FlightforgeSimulator::timerDepth() {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("timerDepth()"); */
...
void FlightforgeSimulator::updateUnrealPoses(const bool teleport_without_collision) {
...

  {
    ...
    for (size_t i = 0; i < uavs_.size(); i++) {
      ...
      auto [roll, pitch, yaw] = pairs_lib::AttitudeConverter(state.R).getExtrinsicRPY();
...
void FlightforgeSimulator::publishStaticTfs(void) {
  ...
  for (size_t i = 0; i < uavs_.size(); i++) {
...

    {
      ...
      Eigen::Matrix3d initial_tf = pairs_lib::AttitudeConverter(Eigen::Quaterniond(-0.5, 0.5, -0.5, 0.5));

      Eigen::Matrix3d dynamic_tf = pairs_lib::AttitudeConverter(M_PI * (rgb_rotation_roll_ / 180.0), M_PI * (rgb_rotation_pitch_ / 180.0), M_PI * (rgb_rotation_yaw_ / 180.0));

      Eigen::Matrix3d final_tf = dynamic_tf * initial_tf;

      tf.transform.rotation = pairs_lib::AttitudeConverter(final_tf);
...

    {
      ...
      Eigen::Matrix3d dynamic_tf = pairs_lib::AttitudeConverter(M_PI * (stereo_rotation_roll_ / 180.0), M_PI * (stereo_rotation_pitch_ / 180.0), M_PI * (stereo_rotation_yaw_ / 180.0));
    ...
    // | ------------------------- lidar tf ------------------------- |
    {
      ...
      pairs_lib::AttitudeConverter ac(M_PI * (lidar_rotation_roll_ / 180.0), M_PI * (lidar_rotation_pitch_ / 180.0), M_PI * (lidar_rotation_yaw_ / 180.0));
...
RCLCPP_COMPONENTS_REGISTER_NODE(pairs_uav_flightforge_simulator::FlightforgeSimulator)
