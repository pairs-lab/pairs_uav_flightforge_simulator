...
#include <pairs_uav_unreal_simulation/unreal_simulatorConfig.h>
...
#include <random>
#include <pairs_uav_unreal_simulation/SetOrientation.h>
//}
...
namespace pairs_uav_unreal_simulation
{
...
private:
  ...
  bool callbackSetRealtimeFactor(pairs_msgs::Float64Srv::Request& req, pairs_msgs::Float64Srv::Response& res);

  std::vector<ros::ServiceClient> set_ground_z_clients_;

  std::vector<ros::ServiceServer> service_gimbal_control_servers_;
  bool callbackSetGimbalOrientation(pairs_uav_unreal_simulation::SetOrientation::Request& req, pairs_uav_unreal_simulation::SetOrientation::Response& res,
                                    int uav_index);
...
/*//}*/
  ...
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::Range>> ph_rangefinders_;

  std::vector<pairs_lib::PublisherHandler<sensor_msgs::PointCloud2>> ph_lidars_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::PointCloud2>> ph_seg_lidars_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::PointCloud2>> ph_int_lidars_;
  ...
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>> ph_rgb_camera_info_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>> ph_rgb_seg_camera_info_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>> ph_stereo_left_camera_info_;
  std::vector<pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>> ph_stereo_right_camera_info_;

  // | ------------------------- system ------------------------- |

  std::vector<std::shared_ptr<pairs_multirotor_simulator::UavSystemRos>> uavs_;
  ...
  typedef pairs_uav_unreal_simulation::unreal_simulatorConfig DrsConfig_t;
  typedef dynamic_reconfigure::Server<DrsConfig_t>          Drs_t;
  boost::shared_ptr<Drs_t>                                  drs_;
  void                                                      callbackDrs(pairs_uav_unreal_simulation::unreal_simulatorConfig& config, uint32_t level);
...
void UnrealSimulator::onInit() {
  ...
  pairs_lib::ParamLoader param_loader(nh_, "UnrealSimulator");
  ...
  for (size_t i = 0; i < uav_names.size(); i++) {
    ...
    uavs_.push_back(std::make_unique<pairs_multirotor_simulator::UavSystemRos>(nh_, uav_name));
  }
  ...
  if (!res || api_version_major != API_VERSION_MAJOR || api_version_minor != API_VERSION_MINOR) {
    ...
    ROS_ERROR("[UnrealSimulator]:           1. make sure the pairs_uav_unreal_simulation package is up to date");
  ...
  for (size_t i = 0; i < uav_names.size(); i++) {
    ...
    ph_rangefinders_.push_back(pairs_lib::PublisherHandler<sensor_msgs::Range>(nh_, "/" + uav_name + "/rangefinder", 10));

    ph_lidars_.push_back(pairs_lib::PublisherHandler<sensor_msgs::PointCloud2>(nh_, "/" + uav_name + "/lidar/points", 10));
    ph_seg_lidars_.push_back(pairs_lib::PublisherHandler<sensor_msgs::PointCloud2>(nh_, "/" + uav_name + "/lidar_segmented/points", 10));
    ph_int_lidars_.push_back(pairs_lib::PublisherHandler<sensor_msgs::PointCloud2>(nh_, "/" + uav_name + "/lidar_intensity/points", 10));
    ...
    ph_rgb_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>(nh_, "/" + uav_name + "/rgb/camera_info", 10));
    ph_rgb_seg_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>(nh_, "/" + uav_name + "/rgb_segmented/camera_info", 10));

    ph_stereo_left_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>(nh_, "/" + uav_name + "/stereo/left/camera_info", 10));
    ph_stereo_right_camera_info_.push_back(pairs_lib::PublisherHandler<sensor_msgs::CameraInfo>(nh_, "/" + uav_name + "/stereo/right/camera_info", 10));
  ...
  for (size_t i = 0; i < uav_names.size(); i++) {
    ...
    set_ground_z_clients_[i] = nh_.serviceClient<pairs_msgs::Float64Srv>(service_name);
    ...
    service_gimbal_control_servers_.push_back(
        nh_.advertiseService<pairs_uav_unreal_simulation::SetOrientation::Request, pairs_uav_unreal_simulation::SetOrientation::Response>(
            gimbal_service_name, [this, i](pairs_uav_unreal_simulation::SetOrientation::Request& req, pairs_uav_unreal_simulation::SetOrientation::Response& res) {
...
void UnrealSimulator::timerRgb([[maybe_unused]] const ros::TimerEvent& event) {
  ...
  /* pairs_lib::ScopeTimer timer = pairs_lib::ScopeTimer("timerRgb()"); */
...
void UnrealSimulator::callbackDrs(pairs_uav_unreal_simulation::unreal_simulatorConfig& config, [[maybe_unused]] uint32_t level) {
  ...
  for (size_t i = 0; i < uavs_.size(); i++) {
...

    {
      ...
      Eigen::Matrix3d dynamic_tf =
          pairs_lib::AttitudeConverter(M_PI * (rgb_rotation_roll_ / 180.0), M_PI * (rgb_rotation_pitch_ / 180.0), M_PI * (rgb_rotation_yaw_ / 180.0));
...

    {
      ...
      Eigen::Matrix3d dynamic_tf =
          pairs_lib::AttitudeConverter(M_PI * (stereo_rotation_roll_ / 180.0), M_PI * (stereo_rotation_pitch_ / 180.0), M_PI * (stereo_rotation_yaw_ / 180.0));
...
bool UnrealSimulator::callbackSetRealtimeFactor(pairs_msgs::Float64Srv::Request& req, pairs_msgs::Float64Srv::Response& res) {
  ...
  pairs_lib::set_mutexed(mutex_drs_params_, params, drs_params_);
...
bool UnrealSimulator::callbackSetGimbalOrientation(pairs_uav_unreal_simulation::SetOrientation::Request&  req,
                                                   pairs_uav_unreal_simulation::SetOrientation::Response& res, int uav_index) {
  ...
  auto [roll, pitch, yaw] = pairs_lib::AttitudeConverter(q).getExtrinsicRPY();
...
void UnrealSimulator::publishCameraTf(const int& uav_index) {
...

  {
    ...
    Eigen::Matrix3d initial_tf = pairs_lib::AttitudeConverter(Eigen::Quaterniond(-0.5, 0.5, -0.5, 0.5));
    Eigen::Matrix3d dynamic_tf = pairs_lib::AttitudeConverter(rgb_camera_orientations_[uav_index]);
    Eigen::Matrix3d final_tf   = dynamic_tf * initial_tf;
    tf.transform.rotation      = pairs_lib::AttitudeConverter(final_tf);
...
PLUGINLIB_EXPORT_CLASS(pairs_uav_unreal_simulation::UnrealSimulator, nodelet::Nodelet)
